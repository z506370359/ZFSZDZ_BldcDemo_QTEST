...
static void PwmInitialize(void)
{
    ...
    TIM1->CCMR1 = 0x00006868;//OC1/2CE = 0 OC1/2M[2:0] = 0b110 pwm mode 1 OC1/2PE = 1 OC1/2FE = 0 CC1/2S[1:0] = 0b00 OUT
    TIM1->CCMR2 = 0x00006868; //OC3/4CE = 0 OC3/4M[2:0] = 0b110 pwm mode 1 OC3/4PE = 1 OC3/4FE = 0 CC3/4S[1:0] = 0b00 OUT
    TIM1->CCER = 0x00001111; //CC1/2/3/4E = 1 
